...
namespace PaintIn3D
{
	...
	public class P3dCommandDecal : P3dCommand
	{
		...
		{
			cachedSpotMaterial = P3dShader.BuildMaterial("Hidden/Paint in 3D/Decal");
			cachedLineMaterial = P3dShader.BuildMaterial("Hidden/Paint in 3D/Decal", "P3D_LINE");
			cachedQuadMaterial = P3dShader.BuildMaterial("Hidden/Paint in 3D/Decal", "P3D_QUAD");
		}
		...
		public void SetMaterial(P3dBlendMode blendMode, Texture texture, Texture shape, P3dChannel shapeChannel, float hardness, float wrapping, float normalBack, float normalFront, float normalFade, Color color, float opacity, Texture tileTexture, Matrix4x4 tileMatrix, float tileOpacity, float tileTransition)
		{
			switch (Extrusions)
			{
				case 0: Material = cachedSpotMaterial; break;
				case 1: Material = cachedLineMaterial; break;
				case 2: Material = cachedQuadMaterial; break;
			}
