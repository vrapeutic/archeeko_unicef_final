...
namespace PaintIn3D.Examples
{
	...
	[HelpURL(P3dHelper.HelpUrlPrefix + "P3dColorCounterEvent")]
...
namespace PaintIn3D.Examples
{
	...
	[CustomEditor(typeof(P3dColorCounterEvent))]
	public class P3dColorCounterEvent_Editor : P3dEditor<P3dColorCounterEvent>
	{
