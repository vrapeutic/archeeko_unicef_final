// Enable this if you want this component to use LeanTouch
//#define USE_LEAN_TOUCH
using UnityEngine;
using System.Collections.Generic;
#if USE_LEAN_TOUCH
using FINGER = Lean.Touch.LeanFinger;
using MANAGER = Lean.Touch.LeanTouch;
#else
...
namespace PaintIn3D
{
	...
	public class P3dHitScreen : P3dConnectablePoints
	{
		...
		public Lean.Touch.LeanFingerFilter Use;
#endif
...
namespace PaintIn3D
{
	...
	public class P3dHitScreen_Editor : P3dConnectablePoints_Editor<P3dHitScreen>
	{
		...
		{
#if USE_LEAN_TOUCH
			Draw("Use", "The method used to find fingers to use with this component. See LeanFingerFilter documentation for more information.");
#endif
