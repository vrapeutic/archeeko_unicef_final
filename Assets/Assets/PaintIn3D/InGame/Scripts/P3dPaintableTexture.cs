...
namespace PaintIn3D
{
	...
	public class P3dPaintableTexture : P3dLinkedBehaviour<P3dPaintableTexture>
	{
		...
		/// <summary>This allows you to specify which channel from the <b>LocalMask</b> texture will be used.</summary>
		...
		private void ExecuteCommands(List<P3dCommand> commands, bool sendNotifications, RenderTexture main, ref RenderTexture swap)
		{
			...
			for (var i = 0; i < commands.Count; i++)
			{
				...
				if (command.Model != null)
				{
					...
					P3dHelper.Draw(command.Material, command.Pass, preparedMesh, preparedMatrix, preparedSubmesh, preparedCoord);
				}
