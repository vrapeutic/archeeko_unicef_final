...
namespace HellTap.MeshKit {
	...
	public class HTGUI : Editor {
		...
		// Textures
		static string loadPrefix = "Hell Tap Entertainment/MeshKit/Shared/"; // We have to do this to fix syntaxing colors (weird)	
	...
	// +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
		...
		public static void WrappedTextLabel( string text, bool useBold = false ){

			// Setup a new text style 
			GUIStyle textStyle = new GUIStyle( GUI.skin.label );
			textStyle.richText = true;
			textStyle.wordWrap = true;
			if( useBold == true ){ textStyle.fontStyle = FontStyle.Bold; }
	...
	// +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
		...
		public static string TagField( Texture2D icon, string label, string defaultString ) { 
		
			// Name / Title of object
			EditorGUILayout.BeginHorizontal();
				GUILayout.Label(icon, GUILayout.MaxWidth(20), GUILayout.MaxHeight(20) );
				GUILayout.Label(label, GUILayout.MinWidth(160), GUILayout.MaxWidth(160), GUILayout.MaxHeight(20));
				defaultString = EditorGUILayout.TagField (string.Empty, defaultString);
			EditorGUILayout.EndHorizontal();
